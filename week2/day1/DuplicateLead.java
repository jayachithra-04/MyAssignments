...
public class DuplicateLead {
	public static void main(String[] args) {
		...
		elementCompanyNameClear.sendKeys("TCS");
		WebElement elementFirstNameClear = driver.findElement(By.id("createLeadForm_firstName"));
		elementFirstNameClear.clear();
		elementFirstNameClear.sendKeys("Jessica");
		WebElement elementSumbitagain = driver.findElement(By.className("smallSubmit"));
		elementSumbitagain.click();
